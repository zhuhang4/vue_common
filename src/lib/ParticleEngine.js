...
ParticleEngine.prototype.initialize = function () {
	...
	for (var i = 0; i < this.particleCount; i++) {
		...
		this.particleGeometry.addAttribute('customVisible', new THREE.BufferAttribute(this.particleArray[i].alive).setDynamic(true));
		this.particleGeometry.addAttribute('customColor', new THREE.BufferAttribute(this.particleArray[i].color).setDynamic(true));
		this.particleGeometry.addAttribute('customOpacity', new THREE.BufferAttribute(this.particleArray[i].opacity).setDynamic(true));
		this.particleGeometry.addAttribute('customSize', new THREE.BufferAttribute(this.particleArray[i].size).setDynamic(true));
		this.particleGeometry.addAttribute('customAngle', new THREE.BufferAttribute(this.particleArray[i].angle).setDynamic(true));
	}
...
ParticleEngine.prototype.update = function (dt) {
	...
	for (var i = 0; i < this.particleCount; i++) {
		if (this.particleArray[i].alive) {
			...
			this.particleGeometry.getAttribute('customVisible').array[i] = this.particleArray[i].alive;
			this.particleGeometry.getAttribute('customColor').array[i * 3 + 0] = this.particleArray[i].color.r;
			this.particleGeometry.getAttribute('customColor').array[i * 3 + 1] = this.particleArray[i].color.g;
			this.particleGeometry.getAttribute('customColor').array[i * 3 + 2] = this.particleArray[i].color.b;
			this.particleGeometry.getAttribute('customOpacity').array[i] = this.particleArray[i].opacity;
			this.particleGeometry.getAttribute('customSize').array[i] = this.particleArray[i].size;
			this.particleGeometry.getAttribute('customAngle').array[i] = this.particleArray[i].angle;
			// this.particleMaterial.attributes.customVisible.value[i] = this.particleArray[i].alive;
			// this.particleMaterial.attributes.customColor.value[i]   = this.particleArray[i].color;
			// this.particleMaterial.attributes.customOpacity.value[i] = this.particleArray[i].opacity;
			// this.particleMaterial.attributes.customSize.value[i]    = this.particleArray[i].size;
