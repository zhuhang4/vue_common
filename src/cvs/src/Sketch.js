export default class Sketch {
    constructor() {
         ...
         * @return {Array}
         */
        sk.dodgeColor=function (basePixes, mixPixes) {
         ...
         * @return {Array}
         */
        sk.gaussBlur=function(pixes, width, height, radius, sigma) {
            var gaussMatrix = [],
                gaussSum = 0,
                x, y,
                r, g, b, a,
         ...
         * @return {Array}
         */
        sk.sketch=function(ctx,imgData, radius, sigma) {
            var pixes = imgData.data,
                width = imgData.width,
                height = imgData.height,
                copyPixes;

            sk.discolor(pixes);//去色
            ...
            sk.invert(copyPixes);//反相
            sk.gaussBlur(copyPixes, width, height, radius, sigma);//高斯模糊
            sk.dodgeColor(pixes, copyPixes);//颜色减淡
            return pixes;
        }
        return sk;
    }
